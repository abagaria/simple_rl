...
def main(open_plot=True):
    # Gym MDP
    gym_mdp = GymMDP(env_name='LunarLander-v2', render=True)
    ...
    run_agents_on_mdp([dqn_agent, rand_agent], gym_mdp, instances=1, episodes=100, steps=200, open_plot=open_plot, verbose=True)
